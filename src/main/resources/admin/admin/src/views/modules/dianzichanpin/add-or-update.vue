<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="产品编号" prop="chanpinbianhao">
					<el-input v-model="ruleForm.chanpinbianhao" placeholder="产品编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.chanpinbianhao" label="产品编号" prop="chanpinbianhao">
					<el-input v-model="ruleForm.chanpinbianhao" placeholder="产品编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="产品类别" prop="chanpinleibie">
					<el-select :disabled="ro.chanpinleibie" v-model="ruleForm.chanpinleibie" placeholder="请选择产品类别" >
						<el-option
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="产品类别" prop="chanpinleibie">
					<el-input v-model="ruleForm.chanpinleibie"
						placeholder="产品类别" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="上架日期" prop="shangjiariqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.shangjiariqi" label="上架日期" prop="shangjiariqi">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="会员价" prop="vipprice">
					<el-input v-model="ruleForm.vipprice" placeholder="会员价" clearable  :readonly="ro.vipprice"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="会员价" prop="vipprice">
					<el-input v-model="ruleForm.vipprice" placeholder="会员价" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="产品介绍" prop="chanpinjieshao">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.chanpinjieshao" label="产品介绍" prop="chanpinjieshao">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.chanpinjieshao"></span>
                </el-form-item>
...
export default {
	...
	this.ruleForm.chanpinjieshao = this.ruleForm.chanpinjieshao.replace(reg,'../../../springbootgqon2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `dianzichanpin/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.dianzichanpinCrossAddOrUpdateFlag = false;
						 this.parent.search();
