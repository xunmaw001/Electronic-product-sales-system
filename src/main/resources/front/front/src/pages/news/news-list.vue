...
<div>
	...
	<div class="news-preview" :style='{"width":"1200px","margin":"10px auto","position":"relative","background":"#f5f5f5"}'>
				...
				<!-- 样式五 -->
		<div class="list5 index-pv1" :style='{"border":"1px solid #dfdfdf","padding":"10px 10px","boxShadow":"1px 2px 3px #eee","margin":"20px 0 0 0","overflow":"hidden","borderRadius":"16px","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","height":"auto"}'>
